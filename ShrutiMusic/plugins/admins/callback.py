...
async def fork_repo_callback(client, query):
    await query.message.edit_text(
        text=(
            "🤡 <b>Bsᴅᴋ Hᴀᴍᴇsʜᴀ Cʜᴏʀɪ ᴋʀɴᴀ...❕</b>\n\n"
            "㊙ @Lᴏʀᴅ_sɪᴋɪᴏ Fɪʀsᴛ Tᴇʟʟ ᴍᴇ ᴘᴀᴘᴀ ɪɴ ᴅᴍ\n"
            "Rᴇᴘᴏ Cʜᴀɪʏᴇ ᴛᴏʜ ᴋʀᴅᴇɴᴀ ᴅᴍ\n\n"
            "🔧 <b>Rᴇᴘᴏ ɴʜɪ ᴍɪʟᴀ Aᴀʙ sᴏᴊᴀ 〽</b>"
        ),
        disable_web_page_preview=True,
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("👨‍💻 Dᴇᴠᴇʟᴏᴘᴇʀ", url="https://t.me/Lord_sikio"),
                    InlineKeyboardButton("🍭 Cʜᴀɴɴᴇʟ", url="https://t.me/ganpat_support")
                ],
                [
